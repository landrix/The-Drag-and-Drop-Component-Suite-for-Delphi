...
{$else}
    // Workaround for BCB problem with default parameters
    function Execute(Asynchronous: boolean): TDragResult; overload; virtual;
    function Execute: TDragResult; overload;
{$endif}
