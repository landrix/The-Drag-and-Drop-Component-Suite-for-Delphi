...
unit ShellCtrls platform; // Sorry. Delphi 6 or later required.
...
begin
  ...
  begin
    ...
    Handles[1] := FMutex;
    Obj := WaitForMultipleObjects(2, PWOHandleArray(@Handles), False, INFINITE);
    case Obj of
      WAIT_OBJECT_0:
        begin
...
begin
  ...
  try
    ...
    Node.CustomSort(TTVCompare(@TreeSortFunc), 0);
  finally
    Items.EndUpdate;
